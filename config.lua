...
Config.Helicopter = "md902" -- Helicopter model that players with the ambulance job can use
...
["main"] = {
    [1] = vector3(299.35, -591.45, 43.28),
},
["stash"] = {
    [1] = vector3(309.78, -596.6, 43.29),
    [2] = vector3(-1433.31, -256.46, 46.48),
},
["beds"] = {
    [1] = {coords = vector4(322.65, -587.46, 45.2, 338.58), taken = false, model = 1631638868},
    [2] = {coords = vector4(317.74, -585.68, 45.2, 338.35), taken = false, model = 1631638868},
    [3] = {coords = vector4(314.61, -584.4, 45.2, 338.24), taken = false, model = 1631638868},
    [4] = {coords = vector4(311.07, -583.08, 45.2, 338.05), taken = false, model = 1631638868},
    [5] = {coords = vector4(307.82, -581.89, 45.2, 338.82), taken = false, model = 1631638868},
    [6] = {coords = vector4(309.21, -577.16, 45.2, 153.28), taken = false, model = -1631638868},
    [7] = {coords = vector4(313.83, -578.93, 45.2, 153.39), taken = false, model = -1631638868},
    [8] = {coords = vector4(319.33, -580.71, 45.2, 153.15), taken = false, model = -1631638868},
--- paleto
