...
["beds"] = {
    [1] = {coords = vector4(322.65, -587.46, 44.2, 338.58), taken = false, model = 1631638868},
    [2] = {coords = vector4(317.74, -585.68, 44.2, 338.35), taken = false, model = 1631638868},
    [3] = {coords = vector4(314.61, -584.4, 44.2, 338.24), taken = false, model = 1631638868},
    [4] = {coords = vector4(311.07, -583.08, 44.2, 338.05), taken = false, model = 1631638868},
    [5] = {coords = vector4(307.82, -581.89, 44.2, 338.82), taken = false, model = 1631638868},
    [6] = {coords = vector4(309.21, -577.16, 44.2, 153.28), taken = false, model = -1631638868},
    [7] = {coords = vector4(313.83, -578.93, 44.2, 153.39), taken = false, model = -1631638868},
    [8] = {coords = vector4(319.33, -580.71, 44.2, 153.15), taken = false, model = -1631638868},
--- paleto
